...
Personal Claude Code plugin (dotfiles submodule at `~/.dotfiles/ecc/`). Provides agents, skills, hooks, commands, rules, and MCP configurations for Python, Go, and TypeScript/JS development.
